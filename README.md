# egov-slack-deploy-cli

Deploy app for egov to deploy any given service to any dev env. Uses [slack-terminalize](https://www.npmjs.com/package/slack-terminalize "slack terminalize at npm") with some basic custom commands
